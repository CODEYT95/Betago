...
public interface EdupostDAO {
    ...
    //게시글 리스트 조회
    List<EdupostDTO> edulist(@Param("page") int page, @Param("size") int size, @Param("searchType") String searchType, @Param("searchType2") String searchType2, @Param("searchType3") String searchType3, @Param("keyword") String keyword);
